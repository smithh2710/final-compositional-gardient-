...
function [stability, x_trial1, x_trial2, TPD_min] = stability_analysis_enhanced(comp, press, temp, Pc, Tc, acentric, BIP, tol, maxiter)
...
for trial = 1:4
    ...
    [u_vapor, converged_v] = qnss_iteration(comp, lnK, press, temp, Pc, Tc, ...
                                            acentric, BIP, lnfugcoef_ref, tol, maxiter, 'vapor');
    [u_liquid, converged_l] = qnss_iteration(comp, lnK, press, temp, Pc, Tc, ...
